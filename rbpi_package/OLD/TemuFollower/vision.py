            ...
            if cv2.contourArea(largest_red) > 500: # Threshold for a valid object
                ...
                if aspect_ratio > 3.0: # Red Line
                    ...
                    if real_y > frame.shape[0] * 0.75:
                        ...
                        cv2.putText(frame, "RED STOP LINE (STOPPING)", (x, real_y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
                    else:
                        # Line is visible but still ahead, do not stop yet
                        cv2.rectangle(frame, (x, real_y), (x + w_box, real_y + h_box), (0, 0, 255), 2)
                        cv2.putText(frame, "Red Line Ahead", (x, real_y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
